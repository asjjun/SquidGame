...
void DataInsert(HeapType* heap) {
	...
	{107, "감기인가"}, {108, "일칠화석"}, {109, "데댸대댸"}, {110, "기억안나"}, {111, "엠엘피"}, {112, "피씨에이"}, {113, "씨엔엔"}, {114, "알엔엔"}, {115, "난바보다"}, {116, "상쾌한향"},
	{117, "업데이트"}, {118, "묬쓔꼤쯰"}, {119, "훠훠궈궈"}, {120, "선형함수"}, {121, "여렵꼤쯰"}, {122, "단여빠꽤"}, {123, "않이외요"}, {124, "않이되요"}, {125, "쁄뼌하졔"}, {126, "헤해혜햬"},
	{127, "아이보리"}, {128, "얘예예애"} };
